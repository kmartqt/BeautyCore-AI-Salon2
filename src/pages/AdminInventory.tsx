    ...
    <div className="max-w-6xl mx-auto space-y-8 h-full flex flex-col relative">
      <div className="flex items-end justify-between shrink-0">
        <div>
          ...
          <p className="text-sm text-[#8C8A84]">Monitor product levels, consumables, and clinic supplies.</p>
        </div>
        <div className="flex gap-4">
          ...
          <button onClick={() => setShowForm(true)} className="px-4 py-2 bg-[#1C1C1C] text-[#C4A47C] text-sm hover:bg-[#2A2A2A] transition-colors rounded-none flex items-center gap-2">
            <Plus size={16} />
            Add Product
          </button>
        </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-white border border-[#E8E6E1] p-4 shrink-0">
        <div className="relative w-full sm:w-96">
          ...
          <input type="text" placeholder="Search by SKU, product name, or category..." className="w-full pl-10 pr-4 py-2 text-sm border border-[#E8E6E1] bg-[#FAFAF9] focus:outline-none focus:border-[#C4A47C] transition-colors rounded-none" />
        </div>
                ...
                <tr key={item.id} className="hover:bg-[#FAFAF9] transition-colors group">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="w-16 h-1 mt-1 bg-[#F5F5F0] overflow-hidden">
                      <div className={`h-full ${item.stock <= item.minStock ? (item.stock <= 5 ? "bg-red-500" : "bg-[#C4A47C]") : "bg-[#1C1C1C]"}`} style={{ width: `${Math.min(100, (item.stock / (item.minStock * 2)) * 100)}%` }} />
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input className="w-full px-4 py-2 border border-[#E8E6E1] focus:outline-none focus:border-[#C4A47C] bg-white text-sm transition-colors" required />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-[#8C8A84] uppercase tracking-wider mb-2">SKU</label>
                    <input className="w-full px-4 py-2 border border-[#E8E6E1] focus:outline-none focus:border-[#C4A47C] bg-white text-sm transition-colors" placeholder="e.g. SKU-123" required />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="number" className="w-full px-4 py-2 border border-[#E8E6E1] focus:outline-none focus:border-[#C4A47C] bg-white text-sm transition-colors" min="0" step="0.01" required />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="number" className="w-full px-4 py-2 border border-[#E8E6E1] focus:outline-none focus:border-[#C4A47C] bg-white text-sm transition-colors" min="0" required />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-[#8C8A84] uppercase tracking-wider mb-2">Minimum Stock</label>
                    <input type="number" className="w-full px-4 py-2 border border-[#E8E6E1] focus:outline-none focus:border-[#C4A47C] bg-white text-sm transition-colors" min="0" required />
                  </div>
                </div>
              </div>
