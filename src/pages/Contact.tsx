    ...
    <div className="pt-24 pb-20 px-6 md:px-12 max-w-[1600px] mx-auto min-h-screen flex flex-col">
      <div className="mb-16 md:mb-24 flex-shrink-0 pt-16">
        ...
        <p className="font-sans text-zinc-400 max-w-2xl leading-relaxed tracking-wide">
          Whether you're looking to book a consultation, inquire about our treatments, or simply learn more about Andrea's Aesthetic &
          Wellness Clinic, we're here to assist you.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 flex-1">
        ...
        <div className="bg-zinc-800/30 p-8 md:p-12 border border-white/5 relative overflow-hidden">
          ...
          <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="font-sans text-xs tracking-[0.1em] text-zinc-400 uppercase">Phone Number</label>
                <input
                  type="tel"
                  className="w-full bg-zinc-900/50 border border-white/10 p-4 text-[#F9F6F0] focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] outline-none transition-all font-sans"
              ...
              <div className="space-y-2">
                <label className="font-sans text-xs tracking-[0.1em] text-zinc-400 uppercase">Preferred Date</label>
                <input
                  type="date"
                  className="w-full bg-zinc-900/50 border border-white/10 p-4 text-[#F9F6F0] focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] outline-none transition-all font-sans"
                />
            ...
            <div className="space-y-2">
              ...
              <textarea
                className="w-full bg-zinc-900/50 border border-white/10 p-4 text-[#F9F6F0] focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] outline-none transition-all font-sans min-h-36"
            ...
            <button
              type="submit"
              className="w-full bg-[#D4AF37] text-zinc-900 font-sans text-xs tracking-[0.2em] uppercase py-4 hover:bg-[#c09d30] transition-colors"
            >
              Send Message
            </button>
          </form>
